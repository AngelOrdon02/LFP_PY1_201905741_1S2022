...
class DashboardView():
    ...
    def __call__():
        ...
        # Botones
        analyzer_button = Button(window, text="Analizador", font=("Arial", 14), command=lambda: clicked())
        analyzer_button.grid(column=1, row=1, padx=5, pady=5)

        reports_button = Button(window, text="Reportes", font=("Arial", 14), command=lambda: clicked())
